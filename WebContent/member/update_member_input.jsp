...
<FORM METHOD="post" ACTION="member.do" name="form1">
	<table class="table">
		...
		<tr>
			...
			<td><input type="TEXT" name="name" size="45"
				value="<%=member.getMemberFullname()%>" /></td>
		</tr>
		<tr>
			<td>會員電子郵件:</td>
		...
		<tr>
			...
			<td><input type="TEXT" name="idcard" size="45"
				value="<%=member.getIdcard()%>" /></td>
		</tr>
		<tr>
			<td>會員帳號:</td>
			<td><input type="TEXT" name="account" size="45"
				value="<%=member.getMemberAccount()%>" /></td>
		</tr>
		<tr>
			<td>會員密碼:</td>
			<td><input type="TEXT" name="password" size="45"
				value="<%=member.getMemberPassword()%>" /></td>
		</tr>
		<tr>
			<td>會員電子錢包餘額:</td>
			<td><input type="number" min="0" max="999999"
				name="ewalletBalance" size="45"
				value="<%=member.getEwalletBalance()%>" /></td>
		</tr>
		<tr>
			<td>帳號建立日期:</td>
		...
		<tr>
			...
			<td><input type="file" accept="image/jpeg, image/png"
				name="picture" size="45" value="<%=member.getProfilePicture()%>" /></td>
		</tr>
		<tr>
			<td>會員狀態:</td>
			<td><input type="TEXT" name="states" size="45"
				value="<%=member.getMemberStatus()%>" /></td>
		</tr>
	...
	<br> <input type="hidden" name="action" value="update"> <input
		type="hidden" name="memberno" value="<%=member.getMemberNo()%>">
	<input type="submit" value="送出修改">
</FORM>
<a href="listAllMember.jsp"><img src="images/back1.png" width="186"
