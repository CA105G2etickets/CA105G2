...
<table>
	...
	<tr>
		<td>商品名稱姓名:</td>
		<td><input type="TEXT" name="goods_name" size="45" value="<%=goodsVO.goods_name()%>" /></td>
	</tr>
	<tr>
		<td>售價</td>
		<td><input type="TEXT" name="goods_price" size="45"	value="<%=goodsVO.goods_price()%>" /></td>
	</tr>
	<tr>
		<td>上架日期:</td>
...
<input type="hidden" name="empno" value="<%=goodsVO.getGoods_no()%>">
...
<% 
  ...
  try {
	  launchdate = goodsVO.getlaunchdate();
	   ...
	   launchdate = new java.sql.Date(System.currentTimeMillis());
   }
%>
