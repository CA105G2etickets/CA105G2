...
<body>
				...
				<div class="col-xs-12 col-sm-3">
					<div class="form-group">
						<label>活動編號</label> <input type="text" name="evetit_no"
							id="evetit_no" class="form-control" value="${goodsVO.evetit_no}">
					</div>
				</div>
				<div class="col-xs-12 col-sm-3">
					<div class="form-group">
	...
	<!-- JavaScript in File -->
	<script
		src="<%=request.getContextPath()%>/backend/event_title/js/eventTitleCKEditor.js"></script>
	<script
		src="<%=request.getContextPath()%>/backend/event_title/js/addEventTitle.js"></script>
	<!-- JavaScript in HTML -->
