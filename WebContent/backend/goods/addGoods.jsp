    	...
    	<div class="container" style="margin-bottom:30px;">    	
	        <form method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/goods/GoodsServlet.do"> 	            
				...
				<span class="form-group">
					<button type="submit" class="btn btn-success" name="action" value="insert" style="margin-top:15px;">儲存</button>
					<a class="btn btn-info" href="<%=request.getContextPath()%>/backend/goods/listAllGoods.jsp" style="margin-top:15px;">回所有商品</a>
				</span>
			</form>
        </div>
