...
<a href="<%=request.getContextPath()%>/backend/member/allMember.jsp"><button type="button" class="btn btn-primary btn-lg btn-block">返回</button></a>
<br>
</div>
