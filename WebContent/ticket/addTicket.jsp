...
<table id="table-1">
	<tr><td>
		 <h3>票券資料新增 - addTicket.jsp</h3></td><td>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="ticarea_no" size="45"
			 value="<%= (tVO==null)? "E000101A01" : tVO.getTicarea_no()%>" /></td>
	</tr>
	<tr>
		<td>訂票訂單編號:</td>
	...
	<tr>
		...
		<td><input type="TEXT" name="member_no" size="45"
			 value="<%= (tVO==null)? "M000001" : tVO.getMember_no()%>" /></td>
	</tr>
	<tr>
		<td>票券狀態:</td>
		<td><input type="TEXT" name="ticket_status" size="45"
			 value="<%= (tVO==null)? "active1" : tVO.getTicket_status()%>" /></td>
	</tr>
	<tr>
		<td>票券成立時間:</td>
	...
	<tr>
		...
		<td><input type="TEXT" name="ticket_resale_status" size="45"
			 value="<%= (tVO==null)? "none1" : tVO.getTicket_resale_status()%>" /></td>
	</tr>
	<tr>
		<td>票券轉讓價格:</td>
		<td><input type="TEXT" name="ticket_resale_price" size="45"
			 value="<%= (tVO==null)? "0" : tVO.getTicket_resale_price()%>" /></td>
	</tr>
	<tr>
		<td>是否來自轉讓:</td>
		<td><input type="TEXT" name="is_from_resale" size="45"
			 value="<%= (tVO==null)? "no" : tVO.getIs_from_resale()%>" /></td>
	</tr>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           ...
           minDate:'<%=ticket_create_time%>', // 去除今日(不含)之前
