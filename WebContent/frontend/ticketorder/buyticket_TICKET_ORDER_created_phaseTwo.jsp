...
//SeatingArea_H5_VO sh5VO = (SeatingArea_H5_VO)request.getAttribute("sh5VO");
...
//pageContext.setAttribute("sh5VO",sh5VO);
%>
...
<!-- ======================================== DAI:::begin ================================================== -->
	...
	<div class="container" style="margin-bottom:30px;">
		<FORM METHOD="post" ACTION="<%=request.getContentType()%>/frontend/ticketorder/ticketorder.do" name="form1" id="payForm">
			<table class="table table-hover table-bordered">
				<tr class="info">
					<th>選擇付款方式</th>
				</tr>
