...
<head>
    ...
    <title>listAllResaleTicketsByTicketStatusAndListEveNo.jsp</title>
        		...
        		<tr>
        			...
        			<td>
        				<form method="post" action="<%=request.getContextPath()%>/frontend/resaleorder/resaleorder.do">
							<input type="hidden" name="action" value="member_select_One_SeatingArea_From_listAllResaleTicketsByTicketStatusAndListEveNo">
