...
import com.ticket.model.Old_TicketDAO;
import com.ticket.model.Old_TicketDAOJDBC;
import com.ticket.model.Old_TicketVO;

public class Old_TicketOrderDAO implements Old_TicketOrderDAO_interface{
...
//		Old_TicketOrderDAO dao = new Old_TicketOrderDAO();
//		//ADD
...
//	}
	...
	public void insertWithTickets(Old_TicketOrderVO ticketorderVO, List<Old_TicketVO> list) {
		...
		try {
			...
			rs.close();
			// 再同時新增票券
			Old_TicketDAO dao = new Old_TicketDAO();
			System.out.println("list.size()-A="+list.size());
			System.out.println("list.toString="+list);
			for (Old_TicketVO aTicketVO : list) {
	...
	public void cancelOneTicketOrderByServlet(Old_TicketOrderVO ticketorderVO, Connection con) {
		PreparedStatement pstmt = null;
		try {
			pstmt = con.prepareStatement(UPDATE);
			pstmt.setString(1, ticketorderVO.getMember_no());
